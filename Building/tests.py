...
class BuildingTestCase(TestCase):
    def setUp(self):
        ...
        User.objects.create_user('Mike2', 'lennon@thebeatles.com', 'ditwachtwoordisgeheim')

    def test_generate_money(self):
        b = building.objects.all()
        u = User.objects.get(username="Mike2")
    ...
    def test_upgrade(self):
        ...
        b.upgrade(p)
        b.upgrade(p)
        pb = player_building.objects.get(player_id=p, building_id=b.building_id)
